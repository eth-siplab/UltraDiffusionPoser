...
def r6d_to_axis_angle(r6d: torch.Tensor):
    r"""
    Turn 6D vectors into axis-angles. (torch, batch)
    ...
    **Warning:** The two 3D vectors of any 6D vector must be linearly independent.
    ...
    """
    return rotation_matrix_to_axis_angle(r6d_to_rotation_matrix(r6d))
...
def rotation_matrix_to_r6d(r: torch.Tensor):
    ...
    """
    return r.view(-1, 3, 3)[:, :, :2].transpose(1, 2).clone().reshape(-1, 6)
